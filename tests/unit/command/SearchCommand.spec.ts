...
beforeEach(() => {
    searchCommand = new SearchCommand(player, mediaItemHelper, queueManager, channelManager, config);
});
...
it.each([undefined, null, ''])('Should send a message for an invalid string if empty / no body given', (body) => {
